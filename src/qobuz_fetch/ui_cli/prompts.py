...
from qobuz_fetch.quality.decision import album_max_quality
from qobuz_fetch.quality.tiers import format_quality
from qobuz_fetch.ui_cli.colors import C, fmt, section, term_width, truncate
from qobuz_fetch.ui_cli.logging import log, vlog
from qobuz_fetch.ui_cli.sentinels import MORE, URL_QUERY
...
def print_consolidation_overview(summaries):
    ...
    from qobuz_fetch.quality.decision import quality_change_summary
...
def print_per_track_consolidation(summary):
    ...
    from qobuz_fetch.quality.decision import _track_quality_cmp
...
def prompt_artist_name():
    ...
    from qobuz_fetch.library.scanner import list_library_artists
