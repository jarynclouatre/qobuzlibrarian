...
from qobuz_fetch.library.scanner import clear_scan_caches, read_album_dir
...
from qobuz_fetch.ui_cli.prompts import log_fetch
...
def _download_for_queue_item(item):
    ...
    propagate to caller."""
    from qobuz_fetch.api.auth import detect_auth_lost, detect_disk_full, detect_rate_limited
    rate_limited = False
