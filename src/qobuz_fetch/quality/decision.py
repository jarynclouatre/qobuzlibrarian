...
from qobuz_fetch.api.search import get_artist_albums, search_artists
...
from qobuz_fetch.library.scanner import clear_scan_caches, list_artist_album_dirs
from qobuz_fetch.library.tags import similarity, strip_album_decorations
...
def scan_artist_for_upgrades(artist_name, artist_dir, token, args, capped=None):
    ...
    """
    from qobuz_fetch.library.catalog import find_expanded_edition, find_qobuz_album_for_dir
