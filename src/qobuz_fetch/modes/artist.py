...
from qobuz_fetch.api.search import get_album, get_artist_albums, search_artists
...
from qobuz_fetch.modes.process import (
    detect_sibling_album_groups,
    pick_canonical_sibling,
    process_album,
)
from qobuz_fetch.quality.decision import compare_album_quality
from qobuz_fetch.queue.builder import _build_queue_item
from qobuz_fetch.queue.executor import _execute_download_queue
from qobuz_fetch.ui_cli.colors import C, banner, fmt, section, truncate
...
def run_artist_gap_fill(artist_name, artist_dir, args, token, *,
    ...
    for i, ad in enumerate(album_dirs, 1):
        ...
        from qobuz_fetch.library.catalog import _paths_equal
