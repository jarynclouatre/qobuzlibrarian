...
from qobuz_fetch.ui_cli.colors import C, banner, fmt
from qobuz_fetch.ui_cli.errors import EXIT_AUTH, EXIT_GENERAL, auth_lost_msg, die
...
def run_album_mode(args, token, *, query_args=None, loop=False):
    ...
    def _flush_queue():
        ...
        _execute_download_queue(album_queue, args, token)
        album_queue.clear()
