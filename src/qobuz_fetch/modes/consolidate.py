...
from qobuz_fetch.library.catalog import maybe_remove_empty_dir
from qobuz_fetch.library.scanner import read_album_dir
from qobuz_fetch.library.tags import normalize, similarity, strip_album_decorations
...
def consolidate_albums(album, args):
    ...
    from qobuz_fetch.library.scanner import read_album_dir as _rad
