...
def _prompt_migration_conflict(src_dir: Path, dest_dir: Path, args):
    ...
    from qobuz_fetch.library.scanner import read_album_dir as _read_album_dir
    from qobuz_fetch.quality.tiers import format_quality
    from qobuz_fetch.ui_cli.prompts import confirm
...
def _merge_album_dirs(src: Path, dst: Path, _depth: int = 0) -> bool:
    ...
    from qobuz_fetch.ui_cli.colors import format_size
    from qobuz_fetch.ui_cli.prompts import confirm
